...
//calculated by calculate_dice_probabilities.c programm
let prob = [
  [
    [0.583333,0.416667,0],
    [0.745370,0.254630,0]
...
//helper function that retrieves the correct data so that we avoid calculating the correct index in the main function
function p (my_armies, opp_armies, want_to_win) {
  return prob[my_armies-1][opp_armies-1][want_to_win];
}

//simulates the game by analyzing any favorable (for the attacker) outcome and returns the sum of their probabilities
